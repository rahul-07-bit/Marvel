      ...
      <div className="max-w-[1400px] mx-auto flex flex-col gap-16 relative z-10">
        ...
        <div className="flex overflow-x-auto gap-8 pb-20 scrollbar-hide snap-x perspective-1000">
          {timelineData.map((item, idx) => (
             <div 
               key={idx} 
               className="min-w-[320px] md:min-w-[450px] h-[550px] md:h-[700px] flex-shrink-0 group relative rounded-[2px] overflow-hidden snap-center border-[1px] border-white/5 bg-[#0a0a0a] transition-all duration-700 hover:border-red-600/50 hover:shadow-[0_0_50px_rgba(236,29,36,0.15)] reveal-item"
